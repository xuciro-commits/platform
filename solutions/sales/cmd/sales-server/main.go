...
var demo = []platformserver.Seat{
	...
	withUnits(seat("manager", "manager-1", map[string]string{"crm": "sales-manager", "hotel": "manager", "memstay": lodging.Keeper, "platform": "admin", "org": "admin", "ai": "admin", "hr": "hr", "work": "admin", "flow": "admin", "agent": "admin", "helpdesk": "lead"}),
