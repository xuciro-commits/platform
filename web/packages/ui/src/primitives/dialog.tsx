  ...
  return (
    <D.Root open={open} onOpenChange={onOpenChange}>
      <D.Portal>
        ...
        <D.Content className="fixed left-1/2 top-1/2 w-[min(480px,calc(100vw-32px))] -translate-x-1/2 -translate-y-1/2 rounded-md border border-border bg-surface p-4 shadow-xl">
