// Shapes of the plant app's read API (apps/manufacturing/server), served by plant-server.
...
export type Planned = { erpId: string; number: string; product: string; quantity: number; due: string; state: string };
