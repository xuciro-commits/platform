...
// With VITE_OIDC_ISSUER the sales host runs on its production path: users sign
// in at the identity provider (deploy/local); without it, demo identities are offered.
const issuer = import.meta.env.VITE_OIDC_ISSUER as string | undefined;
const oidc = issuer ? { issuer, clientId: "sales-web", redirectUri: `${location.origin}/` } : undefined;
