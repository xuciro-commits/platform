...
/** The signed-in member (ADR-0010): one role per app; lines come from the organisation (ADR-0012). */
export type Me = { tenantId: string; principalId: string; profile: { roles: Record<string, string> } };
