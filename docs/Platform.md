...
| Organisation (ADR-0012) | Platform app `org` | Units in dated structures, memberships; rules ask for a member's units at the input's time; working calendars on units, used by approvals and flow timeouts in working days (ADR-0028) | `apps/org` (a package, ADR-0025 D4), `Caller.Units` | MES, HCM, hospitality |
