...
| **114 · accepted; 6a, 6b built; 6c next** | Stage 6 (ADR-0023, accepted): languages (6a built: switch to 简体中文 in the profile menu), the semantic model (descriptions, examples, synonyms declared on entity types, fields, states and actions; served by `/v1/entities`; used by agents, MCP, A2A cards, search and forms), the host API contract (OpenAPI generated from routes and manifests; TypeScript clients generated from it), and the developer kit (app guide, scaffold, skills) | 6b, 6c and 6d meet their done-when (ADR-0023 "Build items"); the owner has walked route 11 in Chinese |
