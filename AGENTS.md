...
| `slices/helpdesk/` | Helpdesk reference app (ADR-0021): tickets with a lifecycle, a service-level flow, and a triage agent whose replies are mailed after a person approves them; runs in the sales solution |
