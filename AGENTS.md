...
| `apps/crm/` | CRM app: accounts, opportunities, stays booked and group blocks held through the lodging protocol, each provider's answer on the opportunity (ADR-0026); knows no other app |
