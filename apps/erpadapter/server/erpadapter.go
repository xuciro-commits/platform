// Package erpadapter connects an ERP outside the platform, such as SAP, to the
...
func (a *App) Manifest() platform.Manifest {
	return platform.Manifest{ID: ID, Title: "ERP adapter", Version: "1", Actions: a.ledger.Catalog, Entities: Entities(), Languages: languages,
